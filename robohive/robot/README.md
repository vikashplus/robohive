...
RoboHive supports all dynamixel based robots such as [ROBEL](https://sites.google.com/view/roboticsbenchmarks). Please follow driver install instructions [here](https://github.com/vikashplus/dynamixel).
