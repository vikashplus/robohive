...
mocap_path="/Users/caggiano/Dropbox (Meta)/mimic/mimic_dataset_mocap/data/human_trajs/"
...
# nice -n 19 python playback_mocap.py --human_motion_file "$mocap_path"/s9/binoculars_pass_1.npz  ./data_myoHand/ik/s9/binoculars_pass_1_myo.npz --start 187 --end 661 --sim_name MyoHandBinocularsFixed-v0 --no_viewer
# nice -n 19 python playback_mocap.py --human_motion_file "$mocap_path"/s1/bowl_pass_1.npz ./data_myoHand/ik/s1/bowl_pass_1_myo.npz --start 74 --end 501 --sim_name MyoHandBowlFixed-v0 --length 90 --no_viewer
